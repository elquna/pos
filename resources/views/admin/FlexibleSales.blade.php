                    ...
                    <div class="col-12">
                        <div class="card">
                            ...
                            <div class="card-content collapse show" style="padding-left:20px">
                               ...
                               Search Start <input type="date" id="startdate"> 

                               &nbsp; Search End <input type="date" id="enddate"> &nbsp; &nbsp; <button onclick="doflexiblesearch()"  class="btn btn-primary">Search </button>   <br><br><br>  
                               
                                <div class="table-responsive" id="reloadd">
